...
class Game():
    ...
    def init_pieces(self):
        self.piece_bitboards["white_rook"] = self.set_bitboard_bit(0, self.piece_bitboards["white_rook"])
        self.piece_bitboards["white_rook"] = self.set_bitboard_bit(7, self.piece_bitboards["white_rook"])
        self.piece_bitboards["white_knight"] = self.set_bitboard_bit(1, self.piece_bitboards["white_knight"])
        self.piece_bitboards["white_knight"] = self.set_bitboard_bit(6, self.piece_bitboards["white_knight"])
        self.piece_bitboards["white_bishop"] = self.set_bitboard_bit(2, self.piece_bitboards["white_bishop"])
        self.piece_bitboards["white_bishop"] = self.set_bitboard_bit(5, self.piece_bitboards["white_bishop"])
        self.piece_bitboards["white_queen"] = self.set_bitboard_bit(3, self.piece_bitboards["white_queen"])
        self.piece_bitboards["white_king"] = self.set_bitboard_bit(4, self.piece_bitboards["white_king"])

        self.piece_bitboards["black_rook"] = self.set_bitboard_bit(63, self.piece_bitboards["black_rook"])
        self.piece_bitboards["black_rook"] = self.set_bitboard_bit(56, self.piece_bitboards["black_rook"])
        self.piece_bitboards["black_knight"] = self.set_bitboard_bit(62, self.piece_bitboards["black_knight"])
        self.piece_bitboards["black_knight"] = self.set_bitboard_bit(57, self.piece_bitboards["black_knight"])
        self.piece_bitboards["black_bishop"] = self.set_bitboard_bit(61, self.piece_bitboards["black_bishop"])
        self.piece_bitboards["black_bishop"] = self.set_bitboard_bit(58, self.piece_bitboards["black_bishop"])
        self.piece_bitboards["black_queen"] = self.set_bitboard_bit(59, self.piece_bitboards["black_queen"])
        self.piece_bitboards["black_king"] = self.set_bitboard_bit(60, self.piece_bitboards["black_king"])

        for i in range(8, 16):
            self.piece_bitboards["white_pawn"] = self.set_bitboard_bit(i, self.piece_bitboards["white_pawn"])
            self.piece_bitboards["black_pawn"] = self.set_bitboard_bit(63 - i, self.piece_bitboards["black_pawn"])


        # DEBUG
        self.piece_bitboards["white_king"] = self.set_bitboard_bit(35, self.piece_bitboards["white_king"])
    ...
    def set_bitboard_bit(self, index, bitboard):
        set_board = np.uint64(1) << np.uint8(index)
        bitboard = np.bitwise_or(bitboard, set_board)
        return bitboard

    def unset_bitboard_bit(self, index, bitboard):
        set_board = np.uint64(1) << np.uint8(index)
    ...
    def make_move(self, move):
        ...
        self.piece_bitboards[mover_type] = self.unset_bitboard_bit(move.start_square, self.piece_bitboards[mover_type])
        if defender_type:
            self.piece_bitboards[defender_type] = self.unset_bitboard_bit(move.end_square, self.piece_bitboards[defender_type])
        self.piece_bitboards[mover_type] = self.set_bitboard_bit(move.end_square, self.piece_bitboards[mover_type])
